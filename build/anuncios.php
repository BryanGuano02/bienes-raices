        ...
        <div class="contenedor-anuncios">
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <img loading="lazy" src="img/anuncio4.jpg" alt="Anuncio casa en el lago">
                </picture>
                <div class="contenido-anuncio">
                    <h3>Casa con alberca</h3>
                    <p>Casa en el lago con excelente vista, acabados de lujo a un excelente precio</p>
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <img loading="lazy" src="img/anuncio5.jpg" alt="Anuncio casa en el lago">
                </picture>
                <div class="contenido-anuncio">
                    <h3>Casa con alberca</h3>
                    <p>Casa en el lago con excelente vista, acabados de lujo a un excelente precio</p>
            ...
            <div class="anuncio">
                <picture>
                    ...
                    <img loading="lazy" src="img/anuncio6.jpg" alt="Anuncio casa en el lago">
                </picture>
                <div class="contenido-anuncio">
                    <h3>Casa con alberca</h3>
                    <p>Casa en el lago con excelente vista, acabados de lujo a un excelente precio</p>
